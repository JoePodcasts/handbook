...
Where appropriate, use callout boxes, arrows, lines and text to draw the learner's attention to a specific area of the screen (for example, when the instructor says "you can see here..."). Use color code ff7400 consistently when adding these attention grabbers.
...
2. Publishing and then downloading
